...
<div class="container">
        <div class="well">
            ...
            <div class="row">
                <!-- Edit btn -->
                <div class="col s1 right">
                    <a class="btn-floating btn-large blue" href="<?php echo ROOT_URL?>editpost.php?id=<?php echo $post['Id'];?>">
                ...
                <div class="col s1 right">
                    <form method="post" action="<?php echo $_SERVER['PHP_SELF'];?>">
                         ...
                         <button class="btn-floating btn-large red" type="submit" name="delete" value="delete">
